...
class UserManagementController extends Controller
{
    public function index()
    {
        if (Auth::user()->role_name=='Admin')
        {
            ...
            $department_type    = DB::table('departments')->get(); 	 
            $status_user        = DB::table('user_types')->get();
            return view('usermanagement.user_control',compact('result','role_name','position','department_type','status_user'));
        }
        else
        {
    ...
    {   
        ...
        // $employees = DB::table('profile_information')->where('id',$profile)->first();
    ...
    public function addNewUserSave(Request $request)
    {
        ...
        try{
            ...
            $user->save();
            DB::commit();
             Alert::success('Create new account successfully :)','Success');
            return redirect()->route('userManagement');
        }catch(\Exception $e){
            DB::rollback();
             Alert::error('User add new account fail :)','Error');
            return redirect()->back();
        }
    }
    // update
    public function update(Request $request)
    {
        ...
        try{
            ...
            DB::rollback();
            Alert::error('User update fail :)','Error');
            return redirect()->back();
        }
    }
    // delete
    public function delete(Request $request)
    {
        ...
        try{
            ...
            DB::rollback();
            Alert::error('User deleted fail :)','Error');
            return redirect()->back();
        }
    }
    ...
    public function changePasswordDB(Request $request)
    {
        ...
        DB::commit();
        Alert::success('User change successfully :)','Success');
